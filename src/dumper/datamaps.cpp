...
std::string GetDatamapFieldTypeName(fieldtype_t type)
{
    ...
    case FIELD_INT32: return "int";
    case FIELD_BOOLEAN: return "boolean";
    case FIELD_INT16: return "int";
    case FIELD_CHARACTER: return "char";
    case FIELD_COLOR32: return "color32";
    case FIELD_EMBEDDED: return "embedded";
    case FIELD_CUSTOM: return "custom";
    case FIELD_CLASSPTR: return "classptr";
    case FIELD_EHANDLE: return "ehandle";
    case FIELD_POSITION_VECTOR: return "position_vector";
    case FIELD_TIME: return "time";
    case FIELD_TICK: return "tick";
    case FIELD_SOUNDNAME: return "soundname";
    case FIELD_INPUT: return "input";
    case FIELD_FUNCTION: return "function";
    case FIELD_VMATRIX: return "vmatrix";
    case FIELD_VMATRIX_WORLDSPACE: return "vmatrix_worldspace";
    case FIELD_MATRIX3X4_WORLDSPACE: return "matrix3x4_worldspace";
    case FIELD_INTERVAL: return "interval";
    case FIELD_UNUSED: return "unused";
    case FIELD_VECTOR2D: return "vector2d";
    case FIELD_INT64: return "int";
    case FIELD_VECTOR4D: return "vector4d";
    case FIELD_RESOURCE: return "resource";
    case FIELD_TYPEUNKNOWN: return "typeunknown";
    ...
    case FIELD_POSITIVEINTEGER_OR_NULL: return "positiveinteger_or_null";
    case FIELD_HSCRIPT_NEW_INSTANCE: return "hscript_new_instance";
    case FIELD_UINT32: return "uint32";
    case FIELD_UTLSTRINGTOKEN: return "utlstringtoken";
    case FIELD_QANGLE: return "qangle";
    case FIELD_NETWORK_ORIGIN_CELL_QUANTIZED_VECTOR: return "network_origin_cell_quantized_vector";
    case FIELD_HMATERIAL: return "hmaterial";
    case FIELD_HMODEL: return "hmodel";
    case FIELD_NETWORK_QUANTIZED_VECTOR: return "network_quantized_vector";
    case FIELD_NETWORK_QUANTIZED_FLOAT: return "network_quantized_float";
    case FIELD_DIRECTION_VECTOR_WORLDSPACE: return "direction_vector_worldspace";
    case FIELD_QANGLE_WORLDSPACE: return "qangle_worldspace";
    case FIELD_QUATERNION_WORLDSPACE: return "quaternion_worldspace";
    case FIELD_HSCRIPT_LIGHTBINDING: return "hscript_lightbinding";
    case FIELD_V8_VALUE: return "v8_value";
    case FIELD_V8_OBJECT: return "v8_object";
    case FIELD_V8_ARRAY: return "v8_array";
    case FIELD_V8_CALLBACK_INFO: return "v8_callback_info";
    case FIELD_UTLSTRING: return "utlstring";
    case FIELD_NETWORK_ORIGIN_CELL_QUANTIZED_POSITION_VECTOR: return "network_origin_cell_quantized_position_vector";
    case FIELD_HRENDERTEXTURE: return "hrendertexture";
    case FIELD_HPARTICLESYSTEMDEFINITION: return "hparticlesystemdefinition";
    case FIELD_UINT8: return "uint8";
    case FIELD_UINT16: return "uint16";
    case FIELD_CTRANSFORM: return "ctransform";
    case FIELD_CTRANSFORM_WORLDSPACE: return "ctransform_worldspace";
    case FIELD_HPOSTPROCESSING: return "hpostprocessing";
    case FIELD_MATRIX3X4: return "matrix3x4";
    case FIELD_SHIM: return "shim";
    case FIELD_CMOTIONTRANSFORM: return "cmotiontransform";
    case FIELD_CMOTIONTRANSFORM_WORLDSPACE: return "cmotiontransform_worldspace";
    case FIELD_ATTACHMENT_HANDLE: return "attachment_handle";
    case FIELD_AMMO_INDEX: return "ammo_index";
    case FIELD_CONDITION_ID: return "condition_id";
    case FIELD_AI_SCHEDULE_BITS: return "ai_schedule_bits";
    case FIELD_MODIFIER_HANDLE: return "modifier_handle";
    case FIELD_ROTATION_VECTOR: return "rotation_vector";
    case FIELD_ROTATION_VECTOR_WORLDSPACE: return "rotation_vector_worldspace";
    case FIELD_HVDATA: return "hvdata";
    case FIELD_SCALE32: return "scale32";
    case FIELD_STRING_AND_TOKEN: return "string_and_token";
    case FIELD_ENGINE_TIME: return "engine_time";
    case FIELD_ENGINE_TICK: return "engine_tick";
    case FIELD_WORLD_GROUP_ID: return "world_group_id";
    case FIELD_GLOBALSYMBOL: return "globalsymbol";
    case FIELD_HNMGRAPHDEFINITION: return "hnmgraphdefinition";
    case FIELD_TYPECOUNT: return "typecount";
    }
...
void CollectDatamapFields(datamap_t* map, nlohmann::json& fields, int& fieldsCount)
{
    ...
    for (int i = 0; i < map->dataNumFields; i++)
    {
        ...
        if (!isInput && !isOutput && (fieldName == "" || externalName == "")) continue;
...
void ReadClassDatamap(CSchemaType_DeclaredClass* declClass, nlohmann::json& outJson, int& fieldsCount)
{
    ...
    if(g_ProcessedClassNames.contains(classInfo->m_pszName)) return;
    ...
    for (const auto& thinkFuncName : g_ThinkFunctionNames)
        if(thinkFuncName.contains(classInfo->m_pszName))
            thinkfunctions.push_back(thinkFuncName);
...
{
    if(!strcmp(a1, "s2dumper")) g_ThinkFunctionNames.insert(a2);
    else if(!strcmp(a2, "s2dumper")) g_ThinkFunctionNames.insert(a1);
...
void CollectThinkFunctions(std::string outputPath)
{
    ...
    FOR_EACH_MAP_FAST(entitySystem->m_entClassesByCPPClassname, i)
    {
        ...
        if(entityClass->m_NameToThinkFunc == 0) continue;
